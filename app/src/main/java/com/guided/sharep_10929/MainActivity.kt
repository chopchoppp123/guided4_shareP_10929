package com.guided.sharep_10929
...
class MainActivity : AppCompatActivity() {
    ...
    fun readData(view: View) {
        ...
        Toast.makeText(baseContext, "data retrieved", Toast.LENGTH_LONG).show()
    }
    ...
    fun clearData(view: View){
        ...
        Toast.makeText(baseContext,"cleared data", Toast.LENGTH_LONG).show()
    }
}